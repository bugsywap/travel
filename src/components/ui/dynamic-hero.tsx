...
export const HeroSection: React.FC<HeroSectionProps> = ({
    ...
    return (
        <div className="bg-background text-foreground flex flex-col pt-12 relative">
            <main className="flex-grow flex flex-col items-center justify-center relative">
                <div className="mt-12 sm:mt-16 lg:mt-24 flex flex-col items-center">
                    ...
                    <p className="mt-3 block text-muted-foreground text-center text-base sm:text-lg px-4 max-w-xl z-20">
                        {tagline}
                    </p>
                </div>
                ...
                <div className="mt-8 flex justify-center z-20">
                    <button
                        ref={targetRef}
                        className="py-2 px-4 rounded-xl border border-border bg-card shadow-sm hover:border-foreground/80 text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
                    >
                        {buttonText}
                    </button>
                </div>

                <div className="mt-12 lg:mt-16 w-full max-w-screen-md mx-auto overflow-hidden px-4 sm:px-2 z-20">
                        ...
                        <div className="relative h-64 sm:h-72 md:h-80 lg:h-96 rounded-[1.75rem] bg-card flex items-center justify-center overflow-hidden">
                            ...
                            {!showVideo && videoUrl && imageUrl && (
                                <button
                                    ...
                                    className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4 z-20 p-2 sm:p-3 bg-white/20 hover:bg-white/40 text-white backdrop-blur-sm rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500"
            ...
            <canvas ref={canvasRef} className="fixed inset-0 pointer-events-none z-[15]"></canvas>
        </div>
    );
};
